...
public class Solution1016DTest {
  ...
  private Solution1016D testObject;

  public Solution1016DTest(String s1, String s2, boolean isInclusion) {
    this.s1 = s1;
    this.s2 = s2;

...
public class Solution1016CTest {
  ...
  private Solution1016C testObject;

  public Solution1016CTest(String s1, String s2, boolean isInclusion) {
    this.s1 = s1;
    this.s2 = s2;

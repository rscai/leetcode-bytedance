...
public class Solution1016BTest {
  ...
  private Solution1016B testObject;

  public Solution1016BTest(String s1, String s2, boolean isInclusion) {
    this.s1 = s1;
    this.s2 = s2;
